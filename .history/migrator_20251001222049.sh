...
# Полный путь к psql для Windows
PSQL_PATH="/c/Program Files/PostgreSQL/13/bin/psql"
...
run_sql() {
    ...
    "/c/Program Files/PostgreSQL/13/bin/psql" -U "$DB_USER" -d "$DB_NAME" -h "$DB_HOST" -p "$DB_PORT" -f "$file"
